...
const DEFAULT_CONTENT = {
  ...
  subtitle: "62 recept fyllda med färg och smak",
  description:
  ...
  shortDescription:
    "Här får du följa med in i en värld av gröna, orange, röda, gula och lila soppor – där grönsakerna står i centrum och kryddor, örter, protein och toppings skapar variation och smak. Dessutom får du inspiration till hälsosamma bröd som passar perfekt att servera till sopporna.",
  image: "/soppboken-omslag.png",
  price: "99 kr",
  features: [
    "Recept på färgstarka och mättande soppor",
    "Inspiration till proteinrika toppings ",
...
export default function SoppbokenPage() {
  ...
  const ebook = {
    id: "soppboken",
    name: "Soppor som gör gott – E-bok av Ulrika Davidsson",
    price: 93.4, // 99 kr inkl 6% moms = 93.40 kr exkl moms (99 / 1.06)
    quantity: 1,
    type: "book" as const,
    image: content.image || "/soppboken-omslag.png",
  };
  ...
  useEffect(() => {
    const fetchContent = async () => {
      try {
        const response = await fetch("/api/pages/soppboken");
        if (response.ok) {
          ...
          >
            <div className="relative group">
              ...
              <div className="relative">
                ...
                >
                  <Image
                    src={content.image || "/soppboken-omslag.png"}
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10">
              ...
              <h3 className="text-white font-semibold mb-2">
                Soppor fyllda med smak
              </h3>
              <p className="text-gray-300 text-sm">
                Upptäck soppor i grönt, orange, rött, gult och lila. Smakrika
                kombinationer med grönsaker, örter och kryddor.
              </p>
            </div>
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10">
              ...
              <p className="text-gray-300 text-sm">
                62 recept på färgstarka och mättande soppor som gör det enkelt
                att variera vardagens måltider.
              </p>
            </div>
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10">
              ...
              <p className="text-gray-300 text-sm">
                Du får inspiration till goda och näringsrika soppor och
                hälsosamma bröd – plus idéer på hur färska, växtbaserade råvaror
                kan bli en naturlig och njutbar del av din vardag.
              </p>
            </div>
          </div>
        </motion.div>

...
function DownloadContent() {
  ...
  const handleDownload = () => {
    ...
    link.download = "den-stora-soppboken-ulrika-davidsson.pdf";
          ...
          <div className="p-6 border-b border-white/10 flex items-center gap-4">
            ...
            <div>
              <h2 className="text-white font-semibold">
                {ebookName || "Grill- & Sommarmat – E-bok"}
              </h2>
              <p className="text-gray-500 text-sm">PDF • 62 smakrika soppor</p>
            </div>
          </div>
